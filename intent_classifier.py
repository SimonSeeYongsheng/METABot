...
class Intent_Classifier:
    ...
    def __init__(self, llm):
        ...
        self.llm = llm
        self.system_prompt = """
        You are an intelligent assistant that classifies user prompts into one of four categories based on their intent:
                    
        1. "General" - The user is engaging in casual conversation or small talk.

        2. "Guidance" - The user is seeking help, suggestions, or instructions related to an assignment or task specifically involving programming.

        3. "Teach" - The user is requesting an explanation, elaboration, or teaching of specific content or concepts related to the course "CS1010S: Programming Methodology." This includes topics such as:
            - Functional Abstraction
            - Recursion
            - Iteration and Order of Growth
            - Higher Order Functions
            - Data Abstraction
            - Working with Sequences
            - Searching and Sorting
            - Dictionaries
            - Implementing Data Structures (e.g., Stack ADT)
        ...
        #     2. "Guidance" - The user is seeking help, suggestions, or instructions related to an assignment or task, or requesting an explanation, elaboration, or teaching of specific content or concepts related to the course "CS1010S: Programming Methodology." This includes topics such as Functional Abstraction, Recursion, Iteration, and Order of Growth, Higher Order Functions, Data Abstraction, Working with Sequences, Searching and Sorting, Dictionaries, Implementing Data Structures (e.g., Stack ADT), Object-Oriented Programming, Dynamic Programming, Memoization, Exceptions, and Data Visualization.
