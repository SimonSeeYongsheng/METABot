...
class Intent_Classifier:
    ...
    def __init__(self, llm):
        ...
        self.system_prompt = """
            ...
            2. "Teaching" - The user is requesting an explanation, elaboration, or teaching of specific content or concepts.
            3. "Guidance" - The user is seeking help, suggestions, or instructions related to an assignment or task.
